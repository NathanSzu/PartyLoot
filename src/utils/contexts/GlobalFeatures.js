...
export const GlobalFeaturesProvider = ({ children }) => {
    ...
    return (
        <GlobalFeatures.Provider
            value={{ showRequestModal, handleCloseRequestModal, handleShowRequestModal, showToast, toggleShowToast, toastContent, setToastContent, toastHeader, setToastHeader }}
        >
            {children}
        </GlobalFeatures.Provider>
    );
