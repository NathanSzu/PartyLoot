        ...
        <ListGroup variant='flush'>
          ...
          {!loading &&
            weapons.map((result, idx) => (
              <ListGroup.Item variant='secondary' onClick={selectWeapon} as={Button} key={idx} id={result.slug}>
                {result.name}
              </ListGroup.Item>
            ))}
        </ListGroup>
        <ListGroup variant='flush'>
          ...
          {!loading &&
            magicItems.map((result, idx) => (
              <ListGroup.Item variant='secondary' onClick={selectMagicItem} as={Button} key={idx} id={result.slug}>
                {result.name}
              </ListGroup.Item>
            ))}
        </ListGroup>
